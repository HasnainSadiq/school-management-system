...
<head>
  <meta charset="utf-8">
    ...
    <title>Scifi Admin - Log in </title>
					...
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{ route('register') }}" class="btn btn-info btn-rounded mt-10">Sign Up</a></p>
							</div>
						</div>
					</div>
				</div>
